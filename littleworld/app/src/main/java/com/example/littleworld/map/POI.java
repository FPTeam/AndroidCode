...
public class POI extends AppCompatActivity implements
    ...
    private void setUpMap() {
        ...
        Button interestButton = (Button) findViewById(R.id.interests);//景点
        interestButton.setOnClickListener(this);

        Button hotelButton = (Button) findViewById(R.id.hotels);//酒店
    ...
    public void planButton() {
        if(trip_Marker_list.size()<1)
            ToastUtil.show(POI.this, "您未选择任何景点！");
        else{
            planTrip();
        }
    }
    ...
    public void planTrip(){
        ...
        if (mStartPoint == null) {
            ToastUtil.show(POI.this, "定位中，稍后再试...");
            return;
        }
        ...
        //float distance = AMapUtils.calculateLineDistance(latLng_start,latLng_end);
    ...
    private void showSuggestCity(List<SuggestionCity> cities) {
        ...
        ToastUtil.show(POI.this, infomation);
    ...
    public void onPoiSearched(PoiResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            ToastUtil.showerror(POI.this, rCode);
        }
